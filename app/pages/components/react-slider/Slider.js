...
export default class Slider extends Component {
  ...
  goPlay () {
    ...
    const isAutoRun = !!((this.props.isAutoRun === undefined || this.props.isAutoRun))
  ...
  render () {
    ...
    const isPause = !!((this.props.isPause === undefined || this.props.isPause))
    const isArrows = !!((this.props.isArrows === undefined || this.props.isArrows))
    const isDots = !!((this.props.isDots === undefined || this.props.isDots))
